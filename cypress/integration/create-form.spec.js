...
describe("Forms", () => {
    it("should create form", () => {
        ...
        cy.wait(1000);
        cy.get(':nth-child(3) > :nth-child(5) > .ng-tns-c64-12').click();
        cy.get('#courseCode').type('1');
        cy.get('.p-autocomplete-dropdown > .p-button-icon').click();
        cy.wait(1000);
        cy.get('#pr_id_7_list > :nth-child(1)').click();
        cy.get('.p-button-raised > .p-button-label').click();
        cy.get('.p-col-2 > .p-button > .p-button-label').click();
        cy.wait(2000);
        cy.get('#p-tabpanel-1-label').click();
        cy.wait(1000);
        cy.get(':nth-child(1) > .p-col-2 > .p-grid > :nth-child(1) > .margin > .p-button-label').click();
        cy.wait(1000);
        cy.get('.p-dialog-header-close-icon').click();
        cy.wait(1000);
        cy.get(':nth-child(1) > .p-col-2 > .p-grid > :nth-child(2) > .margin > .p-button-label').click();
        cy.wait(1000);
        cy.get('.p-dialog-header-close-icon').click();
        cy.wait(1000);
        cy.get(':nth-child(1) > .p-col-2 > .p-grid > :nth-child(3) > .margin > .p-button-label').click();
        cy.wait(1000);
        cy.get('.p-dialog-header-close-icon').click();
    });
});